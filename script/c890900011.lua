...
function s.statcon(e)
	...
	return Duel.IsExistingMatchingCard(aux.FaceupFilter(Card.IsSetCard,0x3dd),tp,LOCATION_MZONE,0,1,nil) or Duel.GetFieldGroupCount(tp,LOCATION_MZONE,0)==0 and Duel.GetLocationCount(tp,LOCATION_MZONE)>0
end
