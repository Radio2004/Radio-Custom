...
local params={fusfilter=aux.FilterBoolFunction(Card.IsCode,11321089),matfilter=Fusion.OnFieldMat(Card.IsAbleToRemove),extrafil=s.fextra,extraop=Fusion.BanishMaterial,extratg=s.extratarget}
