--Attackers and Blockers - Earth Warrior
local s,id=GetID()
function s.initial_effect(c)
	--Search 1 "0x14f1" Monster
...
function s.copfilter(c)
	return c:IsAbleToGraveAsCost() and c:IsCode(1199900004) and c:GetType()==TYPE_SPELL and c:CheckActivateEffect(true,true,false)~=nil 
end
