...
function s.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	local dtab={}
	local b1=Duel.SelectMatchingCard(tp,s.spfilter,tp,LOCATION_HAND,0,1,1,nil,e:GetAttribute(ATTRIBUTE_FIRE))
	local b2=Duel.SelectMatchingCard(tp,s.spfilter,tp,LOCATION_HAND,0,1,1,nil,e:GetAttribute(ATTRIBUTE_WATER))
