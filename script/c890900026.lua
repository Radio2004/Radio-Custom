...
function s.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	local dtab={}
	local b1=Duel.IsExistingMatchingCard(s.spfilter,tp,LOCATION_HAND,0,1,nil,e,tp,att(ATTRIBUTE_FIRE))
	local b2=Duel.IsExistingMatchingCard(s.spfilter,tp,LOCATION_HAND,0,1,nil,e,tp,att(ATTRIBUTE_WATER))
