...
function s.tfilter(c,scard,sumtype,tp)
	...
	return c:IsSummonCode(scard,sumtype,tp,890900035) or c:IsHasEffect(890900032,scard,sumtype,tp) 
	else
...
function s.sfilter(c,scard,sumtype,tp)
	if c:IsHasEffect(890900042,scard,sumtype,tp) then
	return c:IsSummonCode(scard,sumtype,tp,890900036) or c:IsHasEffect(890900032,scard,sumtype,tp)
	else
