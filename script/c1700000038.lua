--Rank-Up-Magic Open Code Rebuild
local s,id=GetID()
...
function s.filter1(c,e,tp)
	...
	return #pg<=1 and c:IsSetCard(0x7cc) and (c:GetRank()>0 or c:IsStatus(STATUS_NO_LEVEL)) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
