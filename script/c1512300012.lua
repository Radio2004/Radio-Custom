...
function s.initial_effect(c)
	...
	local params = {fusfilter=aux.FilterBoolFunction(Card.IsRace,RACE_ROCK),matfilter=Card.IsAbleToRemove,extrafil=s.fextra,extraop=s.extraop,extratg=s.extratarget}
